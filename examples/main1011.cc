...
// Keyword: analysis; rivet; hA collisions; cross-section

// Usage: ./main1011 Beams:idA Beams:idB elab(projectile)
...
int main(int argc, char *argv[]) {
  ...
  std::map<std::string, std::string> idB_map = {
    {"2212", "1H"}, {"1000010020", "2H"}, {"1000060120", "12C"}, {"1000070140", "14N"}, {"1000080160", "16O"}, {"1000180400", "40Ar"}
    };
  ...
  double e_lab = std::stoi(argv[3]); // GeV
  ...
  rivet.addAnalysis("E104_1976_I98502");
